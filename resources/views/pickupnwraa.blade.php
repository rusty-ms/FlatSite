    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                ...
                <style type="text/css">
                    #mc_embed_signup{background:#000; color: #fff; clear:left; font:14px Helvetica,Arial,sans-serif; }
                ...
                <div id="mc_embed_signup">
                    <form action="//nwraasoccer.us14.list-manage.com/subscribe/post?u=8251f3053424e078255bb209f&amp;id=1ed55297c0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                        <div id="mc_embed_signup_scroll">
                            ...
                            <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_8251f3053424e078255bb209f_1ed55297c0" tabindex="-1" value=""></div>
