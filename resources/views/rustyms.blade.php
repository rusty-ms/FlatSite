...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Rusty - Freelance PHP developer, IT Guy, Soccer Coach, and Family man">
    ...
    <link href="http://cdn.idealtechllc.com/rusty.ms/assets/css/main.css" rel="stylesheet">
    ...
    <div class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/">Rusty</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#">Blog</a></li>
            <li><a href="mailto:r@usty.ms">Contact</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 centered">
					<h1>Rusty</h1>
                                        <p>I'm a lot of things and this is what this site will be about.</p>
